...
const RELAY_5 = uint64(0x54ef4410005b2639)
...
var KNOWN_DEVICES map[uint64]DeviceInfo = map[uint64]DeviceInfo{
	...
	RELAY_5:               {9, "Aqara", "SSM-U01", "Реле5", "Реле5", zcl.PowerSource_SINGLE_PHASE, 1, 1},
	...
	MOTION_IKEA:          {8, "IKEA", "E1745", "ИкеаДвижение", "Датчик движения IKEA", zcl.PowerSource_BATTERY, 1, 0},
